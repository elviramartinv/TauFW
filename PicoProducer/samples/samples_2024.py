...
#     store=storage,url=url,files=filelist,opts=opts_dy), 
  ...
  # W+JETS
  M('WJ','WtoTauNu-2Jets',
    "/WtoTauNu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v2/NANOAODSIM",
  ...
  M('WJ','WtoTauNu-2Jets_0J',
    ...
    store=storage,url=url,files=filelist,opts=opts),
  M('WJ','WtoMuNu-2Jets',
    "/WtoMuNu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v2/NANOAODSIM",   
    store=storage,url=url,files=filelist,opts=opts),
  M('WJ','WtoMuNu-2Jets_0J',
    ...
    store=storage,url=url,files=filelist,opts=opts),
  M('WJ','WtoENu-2Jets',
    "/WtoENu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v2/NANOAODSIM",
    store=storage,url=url,files=filelist,opts=opts),
#   M('WJ','WtoLNu-4Jets',
