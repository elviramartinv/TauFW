...
#     store=storage,url=url,files=filelist,opts=opts_dy), 
  ...
  # W+JETS
  M('WJ','WtoTauNu-2Jets',
    "/WtoTauNu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v3/NANOAODSIM",
    store=storage,url=url,files=filelist,opts=opts),
  M('WJ','WtoTauNu-2Jets_0J',
    "/WtoTauNu-2Jets_Bin-0J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v2/NANOAODSIM",
    store=storage,url=url,files=filelist,opts=opts),
  M('WJ','WtoMuNu-2Jets',
    "/WtoMuNu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v3/NANOAODSIM",   
    store=storage,url=url,files=filelist,opts=opts),
  M('WJ','WtoMuNu-2Jets_0J',
    "/WtoMuNu-2Jets_Bin-0J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v2/NANOAODSIM",
    store=storage,url=url,files=filelist,opts=opts),
  M('WJ','WtoENu-2Jets',
    "/WtoENu-2Jets_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v3/NANOAODSIM",
    store=storage,url=url,files=filelist,opts=opts),
  M('WJ','WtoENu-2Jets_0J',
    "/WtoENu-2Jets_Bin-0J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/RunIII2024Summer24NanoAOD-140X_mcRun3_2024_realistic_v26-v2/NANOAODSIM",
    store=storage,url=url,files=filelist,opts=opts),
#   M('WJ','WtoLNu-4Jets',
...
#     store=storage,url=url,files=filelist,opts=opts),
  ...
  D('Data','Muon0_Run2024I',
    ...
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'mutau','mumu','emu','mumutau','mumettau']),
  D('Data','Muon0_Run2024J',"/Muon0/Run2024J-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'mutau','mumu','emu','mumutau','mumettau']),
  ...
  D('Data','Muon1_Run2024I',
    ...
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'mutau','mumu','emu','mumutau','mumettau']),
  D('Data','Muon1_Run2024J',"/Muon1/Run2024J-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'mutau','mumu','emu','mumutau','mumettau']),
  ...
  D('Data','EGamma0_Run2024G',"/EGamma0/Run2024G-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'etau','ee','eetau']),
  D('Data','EGamma0_Run2024H',"/EGamma0/Run2024H-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'etau','ee','eetau']),
  D('Data','EGamma0_Run2024I',
    "/EGamma0/Run2024I-PromptReco-v1/NANOAOD",
    "/EGamma0/Run2024I-PromptReco-v2/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'etau','ee','eetau']),
  D('Data','EGamma0_Run2024J',"/EGamma0/Run2024J-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'etau','ee','eetau']),
  ...
  D('Data','EGamma1_Run2024G',"/EGamma1/Run2024G-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'etau','ee','eetau']),
  D('Data','EGamma1_Run2024H',"/EGamma1/Run2024H-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'etau','ee','eetau']),
  ...
  D('Data','Tau_Run2024G',"/Tau/Run2024G-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'tautau']),
  D('Data','Tau_Run2024H',"/Tau/Run2024H-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'tautau']),
  D('Data','Tau_Run2024I',
    "/Tau/Run2024I-PromptReco-v1/NANOAOD",
    "/Tau/Run2024I-PromptReco-v2/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'tautau']),
  D('Data','Tau_Run2024J',"/Tau/Run2024J-PromptReco-v1/NANOAOD",
    store=storage,url=url,files=filelist,opts=opts,channels=["skim*",'tautau']),
